...
`;
  ...
  const analyzeProperty = useCallback(async (property) => {
    ...
    try {
      ...
      const matchScore = property.matchScore || 85;
...
חשוב! השב בפורמט הבא:
"עכשיו אנחנו מדברים על הנכס: ${property.title}.
על סמך מה שאני יודעת כרגע, מידת ההתאמה היא כ-${matchScore}%.
הנה הסיבות המרכזיות:"

[כאן תן 3-4 נקודות מרכזיות למה זה מתאים]

"וגם נקודה אחת שפחות מתאימה:"
[כאן תן נקודה אחת שפחות מתאימה או שיכולה להיות אתגר]
