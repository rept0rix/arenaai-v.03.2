...
export default function PropertyQuickView({ property, onClose, isInline = false }) {
        ...
        return (
            ...
            >
                ...
                <div className="sticky top-0 bg-white border-b border-slate-200 p-4 flex items-center justify-between z-10">
                    <h3 className="text-xl font-bold text-slate-800">פרטי הנכס</h3>
